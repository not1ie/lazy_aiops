...
// WorkOrderWorkflowRuntime 工单关联的最近一次工作流执行状态
type WorkOrderWorkflowRuntime struct {
	...
	SkippedNodes    int64      `json:"skipped_nodes"`
	FailedNodeID    string     `json:"failed_node_id,omitempty"`
	FailedNodeName  string     `json:"failed_node_name,omitempty"`
	FailedNodeError string     `json:"failed_node_error,omitempty"`
}
