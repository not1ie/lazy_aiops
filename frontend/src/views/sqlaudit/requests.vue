  ...
  <el-card class="page-card">
    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="SQL工单" name="orders">
        ...
        <el-table :fit="true" :data="orders" v-loading="orderLoading" stripe>
      ...
      <el-tab-pane label="数据库实例" name="instances">
        ...
        <el-table :fit="true" :data="instances" v-loading="instanceLoading" stripe>
      ...
      <el-tab-pane label="审计日志" name="logs">
        ...
        <el-table :fit="true" :data="logs" v-loading="logLoading" stripe>
