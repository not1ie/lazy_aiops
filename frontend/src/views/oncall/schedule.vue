<template>
  <el-card class="page-card">
    ...
    <el-row :gutter="12">
      <el-col :md="15" :sm="24">
        <el-card>
          ...
          <el-table :data="schedules" v-loading="loading" stripe @row-click="selectSchedule">
      ...
      <el-col :md="9" :sm="24">
        <el-card>
          ...
          <el-table :data="teams" size="small" stripe>
    ...
    <el-card class="mt-12">
      ...
      <el-table :data="shifts" v-loading="shiftLoading" stripe>
