<template>
  <el-card class="page-card">
    ...
    <el-dialog append-to-body v-model="deviceDialogVisible" :title="deviceEditing ? '编辑设备' : '新增设备'" width="760px" @closed="handleDeviceDialogClosed">
    ...
    <el-dialog append-to-body v-model="ruleDialogVisible" title="新增访问规则" width="700px" @closed="handleRuleDialogClosed">
