<template>
  <div class="executor-page">
    ...
    <el-card class="section-card">
      ...
      <el-table :data="executions" v-loading="loadingExecutions" @row-click="handleSelectExecution" highlight-current-row>
    ...
    <el-card class="section-card" v-if="currentExecution">
      ...
      <el-table :data="results" v-loading="loadingResults" stripe>
